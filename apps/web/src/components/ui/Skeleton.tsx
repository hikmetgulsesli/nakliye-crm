...
function SkeletonItem({ variant = 'text', className }: Omit<SkeletonProps, 'count'>) {
  switch (variant) {
    case 'circle':
      return (
        <div className={cn('animate-pulse bg-slate-200 dark:bg-slate-700 rounded-full size-10', className)} />
      );
    case 'card':
      return (
        <div
          className={cn(
            'animate-pulse bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 space-y-4',
            className,
          )}
        >
    ...
    case 'table-row':
      return (
        <div
          className={cn(
            'animate-pulse flex items-center gap-4 px-6 py-4 border-b border-slate-100 dark:border-slate-800',
            className,
          )}
        >
    ...
    default:
      return (
        <div className={cn('animate-pulse bg-slate-200 dark:bg-slate-700 rounded h-4 w-full', className)} />
      );
  }
}
