  ...
  if (data.length === 0) {
    return (
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-12 text-center">
        ...
        <p className="text-slate-400 text-sm">Log kaydi bulunamadi</p>
      </div>
    );
  }
                ...
                return (
                  <tr key={log.id}>
                    <td colSpan={6} className="p-0">
                      ...
                      >
                        {/* TARIH/SAAT */}
                        <div className="px-6 py-4 text-sm text-slate-600 min-w-[180px]">
                        ...
                        {/* KAYIT TURU */}
                        <div className="px-6 py-4 text-sm text-slate-700 min-w-[120px]">
