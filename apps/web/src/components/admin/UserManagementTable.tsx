      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
            {data.map((user) => (
              <tr key={user.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 dark:bg-slate-800/60 transition-colors">
                {/* KULLANICI */}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-sm font-medium ${
                        user.isActive ? 'text-emerald-700' : 'text-slate-500 dark:text-slate-400'
                      }`}
                    >
                ...
                {/* MUSTERI count */}
                <td className="px-6 py-4 text-center text-sm text-slate-700 dark:text-slate-300 font-medium">
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center justify-center gap-1">
                    ...
                    <button
                      ...
                      className={`p-2 rounded-lg transition-colors ${
                        user.isActive
                          ...
                          : 'text-slate-400 dark:text-slate-500 hover:text-emerald-600 hover:bg-emerald-50'
                      }`}
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg text-slate-400 dark:text-slate-500 hover:text-purple-600 hover:bg-purple-50 transition-colors"
                      title="Devret"
                    >
