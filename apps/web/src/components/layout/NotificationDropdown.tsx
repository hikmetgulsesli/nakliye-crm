...
export default function NotificationDropdown({ open, onClose }: NotificationDropdownProps) {
  ...
  return (
    <div
      ref={ref}
      className="absolute right-0 top-full mt-2 w-96 rounded-2xl border border-slate-200 bg-white shadow-2xl"
    >
      {/* Header */}
      <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
        <h3 className="text-base font-semibold text-slate-900">Bildirimler</h3>
        <button
          onClick={() => markAllRead()}
